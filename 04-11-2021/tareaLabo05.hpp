...
void ListaCircSimple::mostrarListaCircIter(void){
    ...
    if(pInicio){
        ...
        do{
            cout << "\t\tRegistro" << endl;
            cout << "Nombre: " << saltarin->dato.nombre << endl; 
            cout << "ID: " << saltarin->dato.id << endl;
            cout << "Raza: " << saltarin->dato.raza << endl;
            cout << "Edad: " << saltarin->dato.edad << endl;
            cout << "Peso: " << saltarin->dato.peso << endl; 
            saltarin = saltarin->sig;
...
void ListaCircSimple::eliminarListaCircRec(int id)
{
    ...
    if(saltarin->sig == pInicio && saltarin->dato.id == id){
        pInicio = NULL;
        delete saltarin;
        cout << endl << "El paciente ha sido eliminado del registro" << endl; 
    }
